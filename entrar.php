    ...
    <div class="login">
        <div class="logar">
            ...
            <form action="login.php" method="post">
                <input type="email" name="email" id="email_usuario" placeholder="Digite seu e-mail" require>
                <br>
                <input type="password" name="senha" id="senha_usuario" placeholder="Digite sua senha" require>
                <br>
                <input type="submit" name="submit" id="btn_logar" value="ENTRAR">
            </form>
        </div>
        <div class="logar" id="logar1">
            <img src="assets/img/cadastro/login" alt="login">
        </div>
    </div>    
